...
Return list of buffer positions '(yas/snippet-beg yas/snippet-end)."
    ...
    (dolist (snippet snippets)
      (let ((active-field (yas/snippet-active-field snippet)))
        ...
        (cond ((or snippet-exit-transform
               ...
               (let ((temp (yas/commit-snippet snippet)))
                 (setq yas/snippet-beg (car temp))
                 (setq yas/snippet-end (cadr temp))))
              ((and active-field
